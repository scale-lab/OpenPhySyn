...
#ifndef __PHY_STA_DB_NETWORK_H__
#define __PHY_STA_DB_NETWORK_H__
...
class DatabaseStaNetwork : public ConcreteNetwork
{
public:
    DatabaseStaNetwork();
    ...
    virtual bool linkNetwork(const char* top_cell_name, bool make_black_boxes,
                             Report* report);
...
protected:
    void visitConnectedPins(const Net* net, PinVisitor& visitor,
